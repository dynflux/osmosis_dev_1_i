...
exports.handlePageError = function ($P, e, args) {
    ...
    */
    ...
    var errorObj;
    if (e.tellUser) {
        errorObj = { error: { msg: e.message } };
    } else {
        errorObj = { error: { msg: 'Internal server error. It would be greatly appreciated if you report this as a bug to support@osmosis.org.', type: 'Internal' } };
        e.httpStatus = 500;
    }
